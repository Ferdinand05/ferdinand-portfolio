    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ferdinand</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="https://github.com/Ferdinand05" class="hover:underline ">Github</a>
                        </li>
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{ date('Y') }} <a
                    href="/" class="hover:underline">Ferdinand
                </a> created with<span>
            ...
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <svg class="h-4 w-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24"
