        ...
        <x-container>
            ...
            <div class=" grid  md:grid-cols-2 gap-12 place-content-center ">
                ...
                @foreach ($projects as $project)
                    <div
                        class="  max-w-sm md:max-w-lg overflow-hidden   hover:scale-105 duration-150 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="{{ $project->link }}" class="overflow-hidden">
                        ...
                        <div class="p-5 overflow-hidden">
                            ...
                            <div class=" flex pb-3">
                                @foreach ($project->categories as $category)
                                    <span
                                        class="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">{{ $category->name }}</span>
                                @endforeach
                            </div>
                            <a href="{{ $project->link }}"
